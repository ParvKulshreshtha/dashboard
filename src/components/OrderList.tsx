...
const OrderList: FC = () => {
    ...
    return (
        <div className="px-2 py-1">
            ...
            <div className="mt-4">
                <div className="w-full bg-primarylight dark:bg-white/5 flex flex-col md:flex-row gap-4 rounded-sm p-2 justify-between">
                ...
                <div className="mt-3">
                    ...
                    <div className="flex flex-col md:flex-row justify-end items-center mt-3 gap-2">
                        <button
